...
async def callback_handlers(bot: Client, cb: CallbackQuery):
    if "mergeNow" in cb.data:
        ...
        if Config.UPDATES_CHANNEL:
            try:
                ...
                if user.status == "kicked":
                    await cb.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/Unknown_X_Leech).",
                        parse_mode="markdown",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cb.message.edit(
                    text="Something went Wrong. Contact my [Support Group](https://t.me/Unknown_X_Leech).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
        await cb.message.edit(
            text=Config.START_TEXT,
            parse_mode="Markdown",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer - @maheshgreat", url="https://t.me/maheshgreat"), InlineKeyboardButton("Support Group", url="https://t.me/Unknown_X_Leech")], [InlineKeyboardButton("Bots Channel", url="https://t.me/Unknown_X_Updates")]]),
            disable_web_page_preview=True
        )
